...
- **Google** (optional): calendar (create events before listing “tomorrow”), rich **Docs**, **Gmail** brief summaries of what matters most.
...
| `OLLAMA_NUM_PREDICT_GMAIL` | Max tokens for Gmail brief summary (default: 96) |
